...
export const content = {
  kr: {
    lang: "ko",
    metadata: {
      title: "WYD SEOUL 2027 DID 부산",
      description: "WYD SEOUL 2027 DID 부산 공식 웹사이트",
      ogLocale: "ko_KR",
    },
    header: {
      logoAlt: "wyd did 부산",
  ...
  en: {
    lang: "en",
    metadata: {
      title: "WYD SEOUL 2027 DID Busan",
      description: "WYD SEOUL 2027 DID Busan Official Website",
      ogLocale: "en_US",
    },
    header: {
